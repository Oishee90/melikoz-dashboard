...
const users = [
  { id: 1, name: "Jon Doe", joinDate: "15 FEB 25", status: "Active" },
  { id: 2, name: "Alice Smith", joinDate: "22 MAR 25", status: "Suspend" },
  { id: 3, name: "Bob Johnson", joinDate: "12 JAN 25", status: "Active" },
  { id: 4, name: "Jane Lee", joinDate: "01 MAY 25", status: "Suspend" },
  { id: 5, name: "Michael Chen", joinDate: "08 AUG 25", status: "Active" },
  { id: 6, name: "Sarah Kim", joinDate: "19 APR 25", status: "Active" },
  { id: 7, name: "David Brown", joinDate: "30 JUN 25", status: "Suspend" },
];
